...
afAddrType_t SampleAPP_Point_To_Point_DstAddr;//点播
...
{ 
  ...
  //point to point 
  SampleAPP_Point_To_Point_DstAddr.addrMode = (afAddrMode_t)afAddr16Bit;
...
uint16 SampleApp_ProcessEvent( uint8 task_id, uint16 events )
{
  ...
  if ( events & SAMPLEAPP_SEND_PERIODIC_MSG_EVT )//间隔发送消息事件
  {
    // Send the periodic message，广播
